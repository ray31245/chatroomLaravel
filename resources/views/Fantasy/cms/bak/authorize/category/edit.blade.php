		        	...
		        	<ul class="frame">
						...
						@elseif($formKey == 'bForm')
							...
							{{UnitMaker::WNsonTable([
								...
								'hasContent' => 'yes',
								'tip' => '次分類管理',
								'value' => ( !empty($associationData['son']['AuthorizeCategory2']) )? $associationData['son']['AuthorizeCategory2'] : [],
								'name' => 'AuthorizeCategory2',
								'tableSet' => 
								[
									[
										'type' => 'just_show',
						...
						@elseif($formKey == 'cForm')
							...
							{{UnitMaker::WNsonTable([
								...
								'tip' => '輪播圖管理',
								'value' => ( !empty($associationData['son']['AuthorizeCategoryBanner']) )? $associationData['son']['AuthorizeCategoryBanner'] : [],
								'name' => 'AuthorizeCategoryBanner',
								'tableSet' => 
								[
									[
										'type' => 'filesText',
									...
									[
										...
										[
											[
												'type' => 'image_group',
												'title' => '圖片',
												'tip' => '圖片建議尺寸  x  像素，圖片解析度限制:72DPI，檔案格式限定:JPG、PNG、GIF。',
												'image_array' => 
												[
													[
														'title' => '圖片',
