...
<li class="tabulation_body contnetParagraph tabulation_body_{{$randomWord}}" data-table="{{$randomWord}}">
    ...
    @foreach ($value as $key => $row)
        @php
            ...
            // $randomWord_va = '';
            // for ($i = 0; $i < $length; $i++) {
            //     $randomWord_va .= $characters[rand(0, $charactersLength - 1)];
            // }
            ...
            <div class="list_box">
                ...
                @foreach ($tableSet as $key2 => $row2)
                    ...
                    @elseif ($row2['type'] == 'select_just_show')
                        ...
                        @php
                            $auto = (isset($row2['auto'])) ? 'AutoSet_'.$row2['value']:'';
                            $temp_options = (!empty($row2['options'])) ? $row2['options'] : [];
                            $value = (!empty($row[$row2['value']])) ? $row[$row2['value']] : 0;
                        @endphp

                        <div class="item text btn_ctable">
                            @if (isset($temp_options[$value]['title']) and !empty($temp_options[$value]['title']))
                            <p class="{{$auto}}">{{$temp_options[$value]['title']}}</p>
                            @else
                                <p>-</p>
                            @endif
                        </div>
                        ...
                        <div class="item text">
                            <div class="quill_select" style="width:100%;">
                                <div class="select_object" style="border-style: none;">
                                    @if (isset($temp_options[$value]['title']) and !empty($temp_options[$value]['title']))
                                        <p class="title">{{$temp_options[$value]['title']}}</p>
                                    @else
                                        <p class="title"></p>
                                    @endif
                                ...
                                <div class="select_wrapper">
                                    <ul class="select_list edit_select">
                                        ...
                                        <input type="hidden" name="{{$set['name']}}[{{$row2['value']}}][]" value="{{$value}}">
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    @elseif ($row2['type'] == 'just_show')
                        ...
                        @else
                            <div class="item text btn_ctable">
                                <p class="{{$auto}}">{{!empty($row2['default']) ? $row2['default'] : ''}}</p>
                            </div>
                        @endif
                                                ...
                                                <ul class="table_head">
                                                    <li class="table_head_th">
                                                        ...
                                                        @if ($is_photo == 'yes')
                                                            ...
                                                            @else
                                                                <div class="td tool_btn addInThirdTb" data-table="{{$third_randomWord}}" data-content="{{$photo_html}}" toolBtn-id="1">
                                                                    <span class="fa fa-plus"></span>
                                                                    <p>Photo</p>
                                                                </div>
                                                            @endif
                                                        ...
                                                        @if ($is_video == 'yes')
                                                            <div class="td tool_btn addInThirdTb" data-table="{{$third_randomWord}}" data-content="{{$video_html}}" toolBtn-id="2">
                                                                <span class="fa fa-plus"></span>
                                                                <p>Video</p>
                                                            </div>
                                                        @endif
                                                        ...
                                                        @if ($is_embed == 'yes')
                                                            <div class="td tool_btn addInThirdTb" data-table="{{$third_randomWord}}" data-content="{{$embed_html}}" toolBtn-id="3">
                                                                <span class="fa fa-plus"></span>
                                                                <p>Embed Video</p>
                                                            </div>
                                                        @endif
                                                ...
                                                <ul class="table_list quill_partImg table_box thirdTbNew_{{$third_randomWord}}">
                                                    ...
                                                    @foreach ($row['son'][$son_son_db] as $key_son => $value_son)
                                                        @php
                                                            ...
                                                            // $randomWord_son = '';
                                                            // for ($i = 0; $i < $length; $i++) {
                                                            //     $randomWord_son .= $characters[rand(0, $charactersLength - 1)];
                                                            // }
                                                            ...
                                                            if ($value_son['type'] == 1) {
                                                                $thirdCls = 'photo';
                                                            } elseif ($value_son['type'] == 2) {
                                                                $thirdCls = 'video';
                                                            } elseif ($value_son['type'] == 3) {
                                                                $thirdCls = 'Embed';
                                                            } else {
                                                                $thirdCls = '';
                                                            }
                                                        ...
                                                        <li class="item {{$thirdCls}} new_{{$randomWord_son}}" partImg-id="{{$value_son['id']}}" data-rank="{{$keyRank}}">
                                                            ...
                                                            <div class="text">
                                                                <p class="type">{{$value_son['type'] == 0 ? 'Title' : ($value_son['type'] == 1 ? "Photo" : "Video")}}</p>
                                                                <p>
                                                                    <input type="text" value="{{$value_son['title']}}" name="{{$son_son_db}}[title][]" >
                                                                    ...
                                                                    <input type="hidden" value="{{$value_son['second_id']}}" name="{{$son_son_db}}[second_id][]" class="addThirdSid">
                                                                    <input type="hidden" value="{{$value_son['type']}}" name="{{$son_son_db}}[type][]">
                                                                </p>
                                                            </div>
                                                            
                                                            @if (!empty($three["is_add"]) && $three["is_add"] != "yes")
                                                                @if ($value_son['type'] == 1)

                                                                    <div class="edit_thumbnail photo">
                                                                        <div class="base">
                                                                            <img src="{{$imgSrc}}" alt="" class="img_{{$randomWord_son}}">
                                                                            <input type="hidden" value="{{$value_son['image']}}" name="{{$son_son_db}}[image][]" class="value_{{$randomWord_son}}">
                                                                        </div>

                                                                        <div class="upper lbox_fms_open" data-key="{{$randomWord_son}}" data-type="img">
                                                                            <div class="click_btn">
                                                                                <p class="green">Edit</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="edit">
                                                                        ...
                                                                        <span class="fa fa-gear open_preview" data-describe="" data-src="{{$imgSrc}}" data-size="{{$imgSize}}" data-type="image"></span>
                                                                        <input type="hidden" value="{{$value_son['video']}}" name="{{$son_son_db}}[video][]">
                                                                    </div>

                                                                @elseif ($value_son['type'] == 2)

                                                                    <div class="edit_thumbnail video">
                                                                        <div class="base"></div>
                                                                        <div class="upper">
                                                                            <div class="play_btn open_preview">
                                                                                <span></span>
                                                                            </div>

                                                                            <div class="click_btn">
                                                                                <p class="green">Cover</p>
                                                                    ...
                                                                    <div class="edit">
                                                                            <span class="fa fa-trash deleteThirdTableData" data-id="{{$value_son['id']}}" data-key="{{$randomWord_son}}" data-model="{{$son_son_db}}"></span>
                                                                            <span class="fa fa-gear open_preview"></span>
                                                                            <input type="hidden" value="{{$value_son['video']}}" name="{{$son_son_db}}[video][]">
                                                                    </div>

                                                                @elseif ($value_son['type'] == 3)

                                                                    <div class="edit_thumbnail Embed">
                                                                        <div class="base">
                                                                            <img src="{{$imgSrc}}" alt="" class="img_{{$randomWord_son}}">
                                                                            <input type="hidden" value="{{$value_son['image']}}" name="{{$son_son_db}}[image][]" class="value_{{$randomWord_son}}">
                                                                        </div>
                                                                        ...
                                                                        <div class="upper">
                                                                            <div class="play_btn open_preview" data-url="https://www.youtube.com/embed/" data-value="{{$value_son['video']}}" data-key="{{$randomWord_son}}" data-type="embed" data-place="請輸入YouTube影片代碼">
                                                                                <span></span>
                                                                            </div>

                                                                            <div class="click_btn">
                                                                                <p class="green lbox_fms_open" data-key="{{$randomWord_son}}" data-type="img">Cover</p>
                                                                                <p class="gray open_preview" data-url="https://www.youtube.com/embed/" data-value="{{$value_son['video']}}" data-key="{{$randomWord_son}}" data-type="embed" data-place="請輸入YouTube影片代碼">Embed</p>
                                                                                <input type="hidden" value="{{$value_son['video']}}" name="{{$son_son_db}}[video][]" class="video_{{$randomWord_son}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="edit">
                                                                            <span class="fa fa-trash deleteThirdTableData" data-id="{{$value_son['id']}}" data-key="{{$randomWord_son}}" data-model="{{$son_son_db}}"></span>
                                                                            <span class="fa fa-gear open_preview" data-url="https://www.youtube.com/embed/" data-value="{{$value_son['video']}}" data-key="{{$randomWord_son}}" data-type="embed" data-place="請輸入YouTube影片代碼"></span>
                                                                    </div>
                                                                @endif
                                                            @else
                                                                <div class="edit">
