{{-- $video_html = htmlentities($third_html0 . $video_html0 . $third_html1 . $video_html1 . $third_html2 . $video_html2 . $third_html3); --}}
...
<li class="item photo addKeyClass" partImg-id="" data-rank="">
    ...
    @if (!empty($is_add) && $is_add != "yes")
        <div class="edit_thumbnail photo">
            ...
            <div class="upper" data-type="video">
                <input type="hidden" name="{{$son_son_db}}[type][]" value="2">
                ...
                <div class="click_btn">
                    ...
                    <p class="gray">Video</p><input type="hidden" name="{{$son_son_db}}[video][]">
                </div>
    ...
    <div class="edit">
        <span class="fa fa-trash deleteThirdTableData" data-id="" data-key="" data-model="{{$son_son_db}}"></span>Video
    </div>
</li>