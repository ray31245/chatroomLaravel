{{-- $photo_html = htmlentities($third_html0 . $photo_html0 . $third_html1 . $photo_html1 . $third_html2 . $photo_html2 . $third_html3); --}}
...
<li class="item photo addKeyClass" partImg-id="" data-rank="">
    ...
    @if (!empty($is_add) && $is_add != "yes")
        <div class="edit_thumbnail photo">
            <div class="base">
                ...
                <input type="hidden" name="{{$son_son_db}}[type][]" value="1">
            </div>

            <div class="upper lbox_fms_open addImgKey" data-type="img">
                <div class="click_btn">
                    <p class="green">Edit</p>
                    <input type="hidden" name="{{$son_son_db}}[video][]">
                </div>
            </div>
        </div>                                       
    @else
    ...
    <div class="edit">
        ...
        <span class="fa fa-gear open_preview addImgKey" data-describe="" data-src="/vender/assets/img/none-pic.jpg" data-size="" data-type="image"></span>
    </div> 
</li>