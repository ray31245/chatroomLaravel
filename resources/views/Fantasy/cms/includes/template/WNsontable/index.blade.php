                ...
                @foreach ($tableSet as $key2 => $row2)
                    @if ($row2['type'] == 'textInput')
                        ...
                        @if (!empty($row[$row2['value']]))
                            <div class="item text">
                                <input type="text" value="{{$row[$row2['value']]}}" placeholder="Please enter here"  style="border-style:none;background-color: #efefef;border: solid 1px #c7c7c7;width: 90%;" name="{{$set['name']}}[{{$row2['value']}}][]">
                            </div>
                        @else
                            <div class="item text">
                                <input type="text" value="{{!empty($row2['default']) ? $row2['default'] : ''}}" placeholder="Please enter here"  style="border-style:none;background-color: #efefef;border: solid 1px #c7c7c7;width: 90%;" name="{{$set['name']}}[{{$row2['value']}}][]">
                            </div>
                        @endif
                    ...
                    @elseif ($row2['type'] == 'radio_btn')
                        ...
                        @if ($row[$row2['value']] == 0)
                            <div class="item ios_switch radio_btn_switch" style="min-width: 80px;">
                        @else
                    ...
                    @elseif ($row2['type'] == 'select_just_show')
                        ...
                        <div class="item text btn_ctable">
                            @if (isset($temp_options[$this_value]['title']) and !empty($temp_options[$this_value]['title']))
                                <p class="{{(isset($row2['auto'])) ? 'AutoSet_'.$row2['value']:''}}">{{$temp_options[$this_value]['title']}}</p>
                            @else
