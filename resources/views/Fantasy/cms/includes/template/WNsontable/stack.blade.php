...
<div class="list stack_state addDataKey addKeyClass" data-key="">
    <div class="list_box">
        ...
        @foreach ($tableSet as $key2 => $row2)
            ...
            <div class="item text btn_ctable">
                <div class="s_img">
                    <img src="/vender/assets/img/article4/_article.jpg " alt="">
                </div>
                <p class="{{(isset($row2['auto'])) ? 'AutoSet_'.$row2['value']:''}}">{{$row2['options']['_article']['title']}}</p>
            </div>
                            ...
                            @foreach ($row_2['content'] as $key_3 => $row_3)
                                ...
                                @if ($row_3['type'] == 'textInput')
                                    ...
                                    <li class="inventory">
                                        ...
                                        <input class="normal_input {{$auto}}" data-autosetup="{{$autosetup}}" type="text" value="" name="{{$set['name']}}[{{$row_3['value']}}][]" {{(!empty($row_3['disabled'])) ? $row_3['disabled'] : ''}} >
                                        @if (!empty($tip))
                                            <div class="tips">
                                ...
                                @elseif ($row_3['type'] == 'colorPicker') 
                                    ...
                                    @else
                                        <li class="inventory">
                                            <p class="subtitle">{{$title}}</p>
                                            <div class="color_picker">
                                                <input type="text" class="palette" value="" name="{{$set['name']}}[{{$row_3['value']}}][]"/>
                                            </div>
                                            @if (!empty($tip))
                                                <div class="tips">
                                                    <span class="title">TIPS</span>
