            ...
            <div class="inner-content" style="">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:13.5%">姓名</th>
                                        <th style="width:25.5%">信箱</th>
                                ...
                                <tbody class="ams_tbody" data-type="fantasy-account">
                                    ...
                                    <tr class="tbody_tick">
                                        ...
                                        <td class="v-align-middle tool_ctrl edit_ams_wrapper" data-type="fantasy-account" data-id="{{ $row['id'] }}">
                                            <div class="box text_pic">
                                                <div class="head_img open_builder">
                                                    @if(isset($fileInformationArray[ $row['photo_image'] ]) AND
                                                    !empty($fileInformationArray[ $row['photo_image'] ]))
                                                ...
                                                @if(!empty($row['mail']))
                                                <div class="tool">
                                                    <a href="mailto:{{$row['mail']}}"><span
                                                            class="fa fa-envelope open_builder"></span></a>
                                                </div>
                                                @endif
                                            </div>
                                        </td>
                                        <td class="v-align-middle edit_ams_wrapper" data-type="fantasy-account" data-id="{{ $row['id'] }}">
                                            <div class="box text">
                                                @if(!empty($row['name']))
                                                <p>{{ $row['name'] }}</p>
                                                @else
                                        ...
                                        <td class="v-align-middle edit_ams_wrapper" data-type="fantasy-account"
                                            data-id="{{ $row['id'] }}">
                                            <div class="box text">
                                                @if(!empty($row['mail']))
                                                <p>{{ $row['mail'] }}</p>
                                            ...
                                            <div class="box multi">
                                                <ul>
                                                    <li class="{{ ($row['is_active'] == 1) ? 'ch' : '' }} rabioAmsBtn" data-id="{{$row['id']}}"
                                                        data-model="FantasyUsers" data-column="is_active">
                                                        <p>P</p>
                                                    </li>
                                                </ul>
                                            </div>
                ...
                <div class="content-scrollbox" style="position: relative;">
                    <div class="content-wrap main-table index-table-div" data-tableid="new_cms_table">
                        <div class="content-head cms-index_table" data-edit="1" data-delete="1" data-create="1" data-model="FantasyUsers"
                            data-page="1" data-pn="1" data-auth="0" data-pagetitle="Fantasy Account 帳號管理">
                            <h1>Fantasy Account 帳號管理
                            ...
                            <div class="content-nav">
                                <div class="navleft">
                                    <div class="btn-item">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="fantasy-account"
                                            data-id="0">
