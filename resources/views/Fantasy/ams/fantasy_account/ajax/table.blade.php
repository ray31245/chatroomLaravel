                    ...
                    <tr class="tbody_tick">
                        ...
                        <td class="v-align-middle tool_ctrl edit_ams_wrapper" data-type="fantasy-account"
                            data-id="{{ $row['id'] }}">
                    <div class="box text_pic">
                        ...
                        @if(!empty($row['mail']))
                        <div class="tool">
                            <a href="mailto:{{$row['mail']}}"><span class="fa fa-envelope open_builder"></span></a>
                        </div>
                        @endif
                    </div>
                    </td>
                        ...
                        <div class="box multi">
                            <ul>
                                <li class="{{ ($row['is_active'] == 1) ? 'ch' : '' }} rabioAmsBtn"
                                    data-id="{{$row['id']}}" data-model="FantasyUsers" data-column="is_active">
                                    <p>P</p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <tr>
                        ...
                        <td class="w_TableMaintitle edit_ams_wrapper" data-type="fantasy-account"
                            data-id="{{ $row['id'] }}">
                        ...
                        <td class="text-center w_Preview edit_ams_wrapper" data-type="fantasy-account"
                            data-id="{{ $row['id'] }}">
