                            ...
                            <div class="inner-left">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">CMS Template Review 權限管理</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="total">
                            ...
                            <div class="subtitle">
                                ...
                                <ul class="btn-group">
                                    <li class="open_builder" style="background-color: #3a9eea;">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="crs-template"
                                            data-id="0">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody class="ams_tbody" data-type="crs-template">
                                    ...
                                    <tr class="tbody_tick">
                                        ...
                                        <td class="v-align-middle edit_ams_wrapper" data-type="crs-template"
                                            data-id="{{ $row['id'] }}">
                                            <div class="box text">
                    ...
                    <div class="content-wrap main-table index-table-div" data-tableid="new_cms_table">
                        <div class="content-head cms-index_table" data-edit="1" data-delete="1" data-create="1" data-model=""
                            ...
                            <div class="content-nav">
                                <div class="navleft">
                                    <div class="btn-item">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="crs-template" data-id="0">
