                            ...
                            <div class="inner-left">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">CMS Template 功能設定</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="total">
                            ...
                            <div class="subtitle">
                                ...
                                <ul class="btn-group">
                                    <li class="open_builder" style="background-color: #3a9eea;">
                                        <a href="javascript:void(0)" class="create_ams_wrapper"
                                            data-type="template-setting" data-id="0">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:35%">分館</th>
                                        <th style="width:35%">語系</th>
                                ...
                                <tbody class="ams_tbody" data-type="template-setting">
                                    ...
                                    <tr class="tbody_tick">
                                        ...
                                        <td class="v-align-middle edit_ams_wrapper" data-type="template-setting"
                                            data-id="{{ $row['id'] }}">
                                            <div class="box text">
                                                @if(!empty($row['origin_id']))
                                                @foreach($branch_options as $key2 => $row2)
                                                @if($row2['key'] == $row['origin_id'])
                                                <p>{{$row2['title']}}</p>
                                                @endif
                                                @endforeach
                                                @else
                                        ...
                                        <td class="v-align-middle edit_ams_wrapper" data-type="template-setting"
                                            ...
                                            <div class="box text">
                                                @if(!empty($row['locale']))
                                                @foreach($locale_options as $key2 => $row2)
                                                @if($row2['key'] == $row['locale'])
                                                <p>{{$row2['title']}}</p>
                                                @endif
                                                @endforeach
                                                @else
                                            ...
                                            <div class="box multi">
                                                <ul>
                                                    <li class="{{ ($row['is_active'] == 1) ? 'ch' : '' }} rabioAmsBtn" data-id="{{$row['id']}}"
                                                        data-model="BranchOrigin" data-column="is_active">
                                                        <p>P</p>
                                                    </li>
                                                </ul>
                                            </div>
                ...
                <div class="content-scrollbox" style="position: relative;">
                    <div class="content-wrap main-table index-table-div" data-tableid="new_cms_table">
                        <div class="content-head cms-index_table" data-edit="1" data-delete="1" data-create="1" data-model=""
                            data-page="1" data-pn="1" data-auth="0" data-pagetitle="Cover Page 權限管理">
                            <h1>CMS Template 功能設定
                            ...
                            <div class="content-nav">
                                <div class="navleft">
                                    <div class="btn-item">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="template-setting" data-id="0">
                                ...
                                <table class="tables">
                                    ...
                                    <tbody class="ams_tbody" data-type="template-setting">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" w_Category edit_ams_wrapper" data-type="template-setting" data-id="{{ $row['id'] }}">
                                                <div class="tableContent">
                                                    @if(!empty($row['origin_id']))
                                                        @foreach($branch_options as $key2 => $row2)
                                                            @if($row2['key'] == $row['origin_id'])
...
<article class="ams_hiddenArea hiddenArea">
    <!--AMS 編輯管理權限-->
    <form action="" id="ams_edit_form">
    </form>
</article>
@section('script')
@stop
