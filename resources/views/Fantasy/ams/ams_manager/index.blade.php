                    ...
                    <div class="table-box card card-transparent main-table no_left" data-tableID="ams_table">
                        <div class="card-header">
                            <div class="subtitle">
                                <!--按鈕群-->
                                <ul class="btn-group">
                                    <li class="open_builder">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="ams-manager"
                                            data-id="0">
                                    ...
                                    <li class="open_builder" style="display:none;">
                                        <a href="javascript:void(0)">
                                            <span class="fa fa-search"></span>
                                        </a>
                                    </li>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:30%">帳號名稱</th>
                                        <th style="width:13.5%">權限等級</th>
                                        <th style="width:25.5%">AMS管理權限</th>
                                ...
                                <tbody class="ams_tbody" data-type="ams-manager">
                                    ...
                                    <tr class="tbody_tick">
                                        ...
                                        <td class="v-align-middle tool_ctrl edit_ams_wrapper" data-type="ams-manager"
                                            data-id="{{ $row['id'] }}">
                                        ...
                                        <td class="v-align-middle edit_ams_wrapper" data-type="ams-manager"
                                            data-id="{{ $row['id'] }}">
                                            <div class="box text">
                                                @if(!empty($row['role_identity']))
                                                <p>{{ $row['role_identity'] }}</p>
                                                @else
                                                <p>-</p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="box multi">
                                                <ul>
                                                    <li class="{{ ($row['is_active'] == 1) ? 'ch' : '' }} rabioAmsBtn" data-id="{{$row['id']}}"
                                                        data-model="AmsRole" data-column="is_active">
                                                        <p>P</p>
                                                    </li>
                                                </ul>
                                            </div>
                ...
                <div class="content-scrollbox">
                    <div class="content-wrap main-table index-table-div" data-tableid="new_cms_table">
                        <div class="content-head cms-index_table" data-edit="1" data-delete="1" data-create="1" data-model=""
                            data-page="1" data-pn="1" data-auth="0" data-pagetitle="AMS 權限管理">
                            <h1>AMS 權限管理
                                ...
                                <table class="tables">
                                    ...
                                    <tbody class="ams_tbody" data-type="ams-manager">
                                        ...
                                        <tr>
                                            ...
                                            <td class="w_Update open_builder" data-type="ams-manager" data-id="{{ $row['id'] }}">
