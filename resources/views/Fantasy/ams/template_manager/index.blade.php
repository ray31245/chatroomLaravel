                                ...
                                <ul class="btn-group">
                                    <li class="open_builder" style="background-color: #3a9eea;">
                                        <a href="javascript:void(0)" class="create_ams_wrapper"
                                            data-type="template-manager" data-id="0">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:24%">中文名稱</th>
                                        <th style="width:24%">英文名稱</th>
                                        <th style="width:24%">網址標題</th>
                                ...
                                <tbody class="ams_tbody" data-type="template-manager">
                                    ...
                                    <tr class="tbody_tick">
                                        ...
                                        <td class="v-align-middle edit_ams_wrapper" data-type="template-manager"
                                            data-id="{{ $row['id'] }}">
                                            <div class="box text">
                                                @if(!empty($row['title']))
                                                <p>{{ $row['title'] }}</p>
                                ...
                                <table class="tables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w_Category ">
                                                <div class="fake-th ">
                                                    <span class="" data-column="mail">網址標題</span>
                                                </div>
                                            </th>
                                    ...
                                    <tbody class="ams_tbody" data-type="template-manager">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" w_Category edit_ams_wrapper" data-type="template-manager" data-id="{{ $row['id'] }}">
                                                <div class="tableContent">
                                                    @if(!empty($row['title']))
                                                    {{ $row['title'] }}
                                                    @else
