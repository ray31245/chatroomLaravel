...
<div class="backEnd_quill">
    <div class="hiddenArea_frame">
        ...
        <div class="hiddenArea_frame_controlBtn">
            <ul class="btnGroup">
                <li class="check">
                    <a href="javascript:void(0)" class="updated_ams_edit_btn" data-type="cms-overview">
                        <span class="fa fa-check"></span>
                        <p>SETTING</p>
                    </a>
                </li>
                <li class="trash delete_ams_hiddenArea">
                    <a href="javascript:void(0)" class="delete_ams_information" data-type="cms-overview">
                        <span class="fa fa-trash"></span>
                        <p>DELETE</p>
                    </a>
                </li>
