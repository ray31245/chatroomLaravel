                            ...
                            <div class="inner-left">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Fms Folder 基本目錄管理</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="total">
                            ...
                            <div class="subtitle">
                                ...
                                <ul class="btn-group">
                                    <li class="open_builder" style="background-color: #3a9eea;">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="fms-folder"
                                            data-id="0">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:70%">資料夾名稱</th>
                                        <th style="width:10%">狀態</th>
                                        <th style="width:20%">最後異動日期</th>
                                    </tr>
                                </thead>
                                <tbody class="ams_tbody" data-type="fms-folder">
                ...
                <div class="content-scrollbox" style="position: relative;">
                    <div class="content-wrap main-table index-table-div" data-tableid="new_cms_table">
                        <div class="content-head cms-index_table" data-edit="1" data-delete="1" data-create="1" data-model=""
                            data-page="1" data-pn="1" data-auth="0" data-pagetitle="Fms Folder 基本目錄管理">
                            ...
                            <div class="content-nav">
                                <div class="navleft">
                                    <div class="btn-item">
                                        <a href="javascript:void(0)" class="create_ams_wrapper" data-type="fms-folder" data-id="0">
                                ...
                                <table class="tables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w_TableMaintitle ">
                                                <div class="fake-th ">
                                                    <span class="" data-column="account">資料夾名稱</span>
                                                </div>
                                            </th>
                                            {{-- <th class="w_Category ">
                                                <div class="fake-th ">
                                    ...
                                    <tbody class="ams_tbody" data-type="fms-folder">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center w_Preview edit_ams_wrapper" data-type="fms-folder" data-id="{{ $row['id'] }}">
