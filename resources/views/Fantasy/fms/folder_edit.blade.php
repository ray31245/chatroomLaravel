                    ...
                    @if($File['id']!='0')
                        <li class="inventory file_box fileInformation">
                            <div class="file_frame">
                                <div class="file_frame_info">
                                    ...
                                    <div class="info_box">
                                        <p class="type">
                                            ...
                                            <i>|</i>
                                            <span class="number">@if($file_type['title']=='影像') {{ $File['resolution'] }}, @endif{{ $File['_this_size'] }}</span>
                                            <span>, 資料夾內有</span>
                                ...
                                <div class="toolBtn">
                                    @if($area_detail!='資料夾')
                                        <span class="icon fa fa-eye @if($file_type['title']=='影像') open_img_box" @else " onclick="window.open('{{ $File['real_route'] }}')" @endif data-src="{{ $File['real_route'] }}" ></span>
