(function($) {
    ...
    */
    Pages.prototype.getColor = function(color, opacity) {
        ...
        var elem = $('.pg-colors').length ? $('.pg-colors') : $('<div class="pg-colors" style="display:none"></div>').appendTo('body');
...
(function($) {
    ...
    var Progress = function(element, options) {
        ...
        //幫.pie加了個class可以藉由class判別要操控哪個pie
        var a = this.$element.attr('input-circle');

        var cut_a = a.split("_");

        var input_id = cut_a[1];

        this.$pie.addClass('cola_'+ input_id);
...
(function($) {
    ...
    var Sidebar = function(element, options) {
        ...
        this.sideBarWidthCondensed = 250 - 60;
        ...
        // this.$pageContainer.bind('mouseover', sidebarMouseLeave); //原本作者綁定方式，為了ajax後綁定問題，決定修改綁定方式
        this.$body.on('mouseover','.page-container', sidebarMouseLeave);
