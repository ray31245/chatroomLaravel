  ...
  Cropper.TEMPLATE = (
    '<div class="cropper-container">' +
      ...
      '<div class="cropper-crop-box">' +
        ...
        '<div class="cropper-inforBox">' +
          '<div class="cropper-inforGroup">' +
            '<span class="cropper-Xinfor"></span>' +
            '<span class="cropper-Yinfor"></span>' +
          '</div>' +
          '<div class="cropper-inforGroup">' +
            '<span class="cropper-Winfor"></span>' +
            '<span class="cropper-Hinfor"></span>' +
          '</div>' +
        '</div>' +
      '</div>' +
    '</div>'
