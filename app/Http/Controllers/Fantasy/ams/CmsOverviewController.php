...
class CmsOverviewController extends AmsPaPa 
{
	...
	{
		$data = CmsRole::where('type',1)->with('UsersData')->get()->toArray();
		return View::make('Fantasy.ams.cms_overview.index',
		[
			'data' => $data
		]);
	}
	...
	{
		$data = CmsRole::where('type',1)->with('UsersData')->get()->toArray();
		return View::make('Fantasy.ams.cms_overview.ajax.table',
		[
			'data' => $data
		]);
	}
